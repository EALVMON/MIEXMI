...
class CeefAdaptador(
    // Recibe la lista completa con todas las especialidades que hay que mostrar.
    ...
    // RELLENAR LOS DATOS
    override fun onBindViewHolder(holder: CeefViewHolder, position: Int) {
        // Busca en nuestra lista de datos la linea de nuestra especialidad que toca dibujar
        ...
        // Si el usuario toca esa fila, activamos el 'listener' y enviamos los datos de la especialidad que tocó.
    ...
    class CeefViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {

        // Enlazamos las variables de Kotlin con los IDs que creé en el diseño XML.
        val tvNumFila: TextView = itemView.findViewById(R.id.tvItemNumCEEF)
        val tvNombre: TextView = itemView.findViewById(R.id.tvItemNombreCEEF)
        val tvFechaBod: TextView = itemView.findViewById(R.id.tvItemFechaCEEF)
        val tvNumBod: TextView = itemView.findViewById(R.id.tvItemBodCEEF)
    }
}