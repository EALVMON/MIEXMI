...
class PU13 {
    ...
    fun verificarLogicaAlertasTMI() {
        ...
        // 1- TMI que caduca en 1 mes (DENTRO DEL RANGO DE 3 MESES) ---
        ...
        // 2- TMI que caduca en 5 meses (FUERA DEL RANGO) ---
        ...
        // 3- TMI que ya caducó hace 10 días ---
        ...
        // 4-Texto que no es una fecha
        //  devuelve false, evitando que la app se cierre
        assertFalse(
